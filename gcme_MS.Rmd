...
dim(subset(gcme,condition=="co2" &is.na(type_name)==T)) # vcmax numbers
dim(subset(gcme,condition=="co2" &is.na(type_name)==T&is.na(jmax)==F)) # jmax numbers

dim(subset(gcme,is.na(nmass)==F))
dim(subset(gcme,is.na(narea)==F))
dim(subset(gcme,is.na(LMA)==F))
dim(subset(gcme,is.na(anpp)==F))
dim(subset(gcme,is.na(bnpp)==F))
dim(subset(gcme,is.na(lai)==F))
dim(subset(gcme,is.na(root_shoot_ratio)==F))
dim(subset(gcme,is.na(soil_mineral_N)==F))
