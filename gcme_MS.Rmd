...
#type_1 high N
a1 <- subset(gcme_nfer,condition=="highN"|condition=="lowN")[c(1,3,5,7,9,11,13),c("exp","vcmax","jmax","jmax_vcmax","condition")]
#type1 low N
a2 <- subset(gcme_nfer,condition=="highN"|condition=="lowN")[c(2,4,6,8,10,12,14),c("exp","vcmax","jmax","jmax_vcmax","condition")]
...
f1 <- gcme_nfer %>%
  ...
  geom_jitter(data=subset(df3,condition=="highN"),aes(x=type_box, y=ratio_v),size=2,color="black",width = 0.3)+
  geom_jitter(data=subset(df3,condition=="Fertilization"),aes(x=type_box, y=ratio_v),size=2,color="blue",width = 0.3)+
  theme_classic()+coord_flip()+theme(axis.text=element_text(size=12))
...
f2 <- gcme_nfer %>%
  ...
  geom_jitter(data=subset(df3,condition=="highN"),aes(x=type_box, y=ratio_j),size=2,color="black",width = 0.3)+
  geom_jitter(data=subset(df3,condition=="Fertilization"),aes(x=type_box, y=ratio_j),size=2,color="blue",width = 0.3)+
  theme_classic()+coord_flip()+theme(axis.text=element_text(size=12))
...
f3 <- gcme_nfer %>%
  ...
  geom_jitter(data=subset(df3,condition=="highN"),aes(x=type_box, y=ratio_jv),size=2,color="black",width = 0.3)+
  geom_jitter(data=subset(df3,condition=="Fertilization"),aes(x=type_box, y=ratio_jv),size=2,color="blue",width = 0.3)+
  theme_classic()+coord_flip()+theme(axis.text=element_text(size=12))
